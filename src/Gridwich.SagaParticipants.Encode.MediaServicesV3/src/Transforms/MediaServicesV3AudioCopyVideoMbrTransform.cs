...
{
    /// <summary>
    /// Concrete class that contains the logic and Transform for the AudioCopy custom Transform.  If changes need to be made,
    /// you should create a new custom class with a new name.
    /// </summary>
    public class MediaServicesV3AudioCopyVideoMbrTransform : MediaServicesV3TransformBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaServicesV3AudioCopyVideoMbrTransform"/> class.
        /// </summary>
        /// <param name="name">The name of the transform</param>
        public MediaServicesV3AudioCopyVideoMbrTransform(string name)
            : base(name)
        {
            Create();
        }
        ...
        {
            public static bool? AdaptiveBFrame { get { return true; } }
