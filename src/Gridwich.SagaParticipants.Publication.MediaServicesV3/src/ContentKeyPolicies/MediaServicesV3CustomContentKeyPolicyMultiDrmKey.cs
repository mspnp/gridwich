...
{
    /// <summary>
    /// Concrete class that contains the logic and content key policy for the multi DRM Content Key Policy.
    ...
    /// - FairPlay
    /// </summary>
    public class MediaServicesV3CustomContentKeyPolicyMultiDrmKey : MediaServicesV3CustomContentKeyPolicyBase
    {
        ...
        /// </summary>
        private readonly string name = CustomContentKeyPolicies.MultiDrmKey;

        /// <summary>
        /// Initializes a new instance of the <see cref="MediaServicesV3CustomContentKeyPolicyMultiDrmKey"/> class.
        /// </summary>
        ...
        public MediaServicesV3CustomContentKeyPolicyMultiDrmKey(string openIdConnectDiscoveryDocument, string fairPlayPfxPassword, string fairPlayAskHex, string fairPlayPfx)
        ...
        private List<ContentKeyPolicyOption> GetPolicyOptions()
        {
            ...
            return new List<ContentKeyPolicyOption>
            {
                ...
                // FairPlay Persistent None
                new ContentKeyPolicyOption()
                {
                    Configuration = ConfigureFairPlayPolicyOptionsPersistentNone(),
                    Restriction = restriction_persistent_none,
                    Name = "ContentKeyPolicyOption_CBCS_Persistent_None"
                },

                // FairPlay Persistent 2 Hours
                new ContentKeyPolicyOption()
                {
                    Configuration = ConfigureFairPlayPolicyOptionsPersistent(durationOf2Hours),
                    Restriction = restriction_persistent_2Hours,
                    Name = "ContentKeyPolicyOption_CBCS_Persistent_2Hours"
                },

                // FairPlay Persistent 14 Days
                new ContentKeyPolicyOption()
                {
                    Configuration = ConfigureFairPlayPolicyOptionsPersistent(durationOf14Days),
                    Restriction = restriction_persistent_14Days,
                    Name = "ContentKeyPolicyOption_CBCS_Persistent_14Days"
                },
            };
        }

        /// <summary>
        /// Configures FairPlay policy options for non persistent licenses.
        /// </summary>
        /// <returns>The FairPlay option</returns>
        private ContentKeyPolicyFairPlayConfiguration ConfigureFairPlayPolicyOptionsPersistentNone()
        {
            return new ContentKeyPolicyFairPlayConfiguration
            {
                Ask = FairPlayAskBytes,
                FairPlayPfx = FairPlayPfx,
                FairPlayPfxPassword = FairPlayPfxPassword,
                RentalAndLeaseKeyType = ContentKeyPolicyFairPlayRentalAndLeaseKeyType.Undefined
            };
        }

        /// <summary>
        /// Configures FairPlay policy options for persistent licenses.
        /// </summary>
        /// <returns>The FairPlay option</returns>
        private ContentKeyPolicyFairPlayConfiguration ConfigureFairPlayPolicyOptionsPersistent(TimeSpan licenseDuration)
        {
            return new ContentKeyPolicyFairPlayConfiguration
            {
                Ask = FairPlayAskBytes,
                FairPlayPfx = FairPlayPfx,
                FairPlayPfxPassword = FairPlayPfxPassword,
                RentalAndLeaseKeyType = ContentKeyPolicyFairPlayRentalAndLeaseKeyType.PersistentLimited,
                RentalDuration = Convert.ToInt64(licenseDuration.TotalSeconds)
            };
        }
