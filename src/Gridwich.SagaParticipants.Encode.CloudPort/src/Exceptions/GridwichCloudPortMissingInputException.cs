...
{
    /// <summary>
    /// Throws when a CloudPort encode cannot find one or more input blobs.
    /// </summary>
    ...
    public class GridwichCloudPortMissingInputException : GridwichException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GridwichCloudPortMissingInputException"/> class.
        /// </summary>
        ...
        public GridwichCloudPortMissingInputException(string message, string missingUrl, JObject operationContext)
         : base(message, LogEventIds.CloudPortMissingInputError, operationContext)
        {
            StoreUri(missingUrl);
        }
        ...
        public GridwichCloudPortMissingInputException(string message, string missingUrl, JObject operationContext, Exception innerException)
         : base(message, LogEventIds.CloudPortMissingInputError, operationContext, innerException)
        {
            StoreUri(missingUrl);
        }
