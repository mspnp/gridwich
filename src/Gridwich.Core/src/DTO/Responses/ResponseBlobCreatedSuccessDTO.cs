...
{
    /// <summary>
    /// This class provides a Gridwich-specific message for the StorageBlobCreatedEvent.
    /// </summary>
    public sealed class ResponseBlobCreatedSuccessDTO : ResponseBaseDTO
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseBlobCreatedSuccessDTO"/> class.
        /// </summary>
        public ResponseBlobCreatedSuccessDTO()
            : base(CustomEventTypes.ResponseBlobCreatedSuccess)
        {
        }
    }
}