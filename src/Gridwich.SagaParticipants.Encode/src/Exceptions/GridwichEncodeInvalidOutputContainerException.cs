...
namespace Gridwich.SagaParticipants.Encode.Exceptions
{
    ...
    /// </summary>
    public class GridwichEncodeInvalidOutputContainerException : GridwichException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GridwichEncodeInvalidOutputContainerException"/> class.
        /// </summary>
        ...
        public GridwichEncodeInvalidOutputContainerException(string message, JObject operationContext, Exception innerException, EventId logEventId)
